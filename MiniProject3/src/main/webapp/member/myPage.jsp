...
<body>
	<div id="container">
		...
		<form>
			<h1>MYPAGE</h1>
			<p>아이디</p>
			<input type="text" value="${loginMember.uid}" readonly="readonly"/><br/>
			<p>비밀번호</p>
			<input type="text" value="${loginMember.pwd}" readonly="readonly"/><br/>
			<p>이 름</p>
			<input type="text" value="${loginMember.name}" readonly="readonly"/><br/>
			<p>전화번호</p>
			...
			<div class="links">
				...
				<% if (loginMember.getUid().equals("admin")) { %>
